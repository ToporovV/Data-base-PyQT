...
import time
import unittest
from lesson_03.client import create_new_presence, process_response_answer
from lesson_03.common.variables import ACTION, PRESENCE, TIME, USER, ACCOUNT_NAME, RESPONSE, ERROR
from lesson_03.errors import ReqFieldMissingError
...
class TestClient(unittest.TestCase):
    ...
    def test_process_answer_res_400(self):
        ...
        self.assertEqual(process_response_answer({RESPONSE: 400, ERROR: 'Bad Request'}), '400 : Bad Request')

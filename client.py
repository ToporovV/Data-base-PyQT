...
from lesson_03.common.variables import ACTION, PRESENCE, TIME, USER, ACCOUNT_NAME, \
...
from lesson_03.decos import log
from lesson_03.errors import ReqFieldMissingError, ServerError, IncorrectDataReceivedError

from lesson_03.logs.configs.config_client_log import LOGGER as CLIENT_LOGGER  # Инициализация клиентского логера
from lesson_03.metaclasses import ClientMaker
